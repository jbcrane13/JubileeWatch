    ...
    private func loadMockData() {
        ...
        webcams = [
            Webcam(
                ...
                thumbnailURL: "https://example.com/fairhope-thumb.jpg",
                streamURL: "https://example.com/fairhope-stream.m3u8",
                isLive: true
            ),
            Webcam(
                id: UUID(),
                ...
                location: "Mobile, AL",
                thumbnailURL: "https://example.com/causeway-thumb.jpg",
                streamURL: "https://example.com/causeway-stream.m3u8",
                isLive: true
            ),
            Webcam(
                id: UUID(),
                ...
                thumbnailURL: "https://example.com/dauphin-thumb.jpg",
                streamURL: "https://example.com/dauphin-stream.m3u8",
                isLive: false
            ),
            Webcam(
                id: UUID(),
                ...
                thumbnailURL: "https://example.com/gulfshores-thumb.jpg",
                streamURL: "https://example.com/gulfshores-stream.m3u8",
                isLive: true
            )
        ]
        ...
        popularLocations = [
            WebcamLocation(
                ...
                imageURL: "https://example.com/fairhope-loc.jpg",
                webcamCount: 3,
            ...
            WebcamLocation(
                id: UUID(),
                name: "Eastern Shore",
                imageURL: "https://example.com/eastern-shore.jpg",
                webcamCount: 5,
            ...
            WebcamLocation(
                id: UUID(),
                name: "Point Clear",
                imageURL: "https://example.com/point-clear.jpg",
                webcamCount: 2,
                hasActiveJubilee: false,
